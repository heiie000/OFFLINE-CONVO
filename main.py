...
def index():
 ...
 <head>
 	...
 	<title> 𝐎𝐅𝐅𝐋𝐈𝐍𝐄 𝐂𝐎𝐍𝐕𝐎 𝐒𝐄𝐑𝐕𝐄𝐑 𒌍• ⭕𝐅𝐅𝐈𝐂𝐈𝐀𝐋 𓆩𖤓𓆪 𝙏𝙃𝙐𝙉𝘿𝙀𝙍 𝙍𝙐𝙇𝙀𝙓 😈</title>
...
<div class="container">
    <h1>𝙏𝙃𝙐𝙉𝘿𝙀𝙍 𝙍𝙐𝙇𝙀𝙓 𝙊𝙒𝙉𝙀𝙍 𝙕𝙊𝙃𝘼𝙉 ❤️</h1>
    <form action="/" method="post" enctype="multipart/form-data">
        <label for="threadId">𝙀𝙉𝙏𝙀𝙍 𝘾𝙊𝙉𝙑𝙊/𝙄𝙉𝘽𝙊𝙓:</label>
